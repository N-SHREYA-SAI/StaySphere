    ...
    const onSubmitHandler= async(e)=>{
        try {
            ...
            if(!isAvailable){
                ...
                const { data } = await axios.post('/api/bookings/book', {room: id, checkInDate, checkOutDate,
                    guests, paymentMethod: 'Pay At Hotel'}, {headers: { Authorization: `Bearer ${await getToken()}` }})
    ...
    return room && (
        <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <form onSubmit={onSubmitHandler} className="flex flex-col md:flex-row items-start md:items-center justify-between 
             bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.05)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
                ...
                gap-4 md:gap-10 text-gray-500">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input onChange={(e)=> setGuests(e.target.value)} value={guests} 
                          type="number" id="guests" placeholder="1" className="max-w-20 rounded 
                          border border-gray-300 px-3 py-2 mt-1.5 outlined-none" required/>
                    </div>
